...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. memory_scope — tenant+user scoping provided by gateway (e.g. Discord guild+user).
        #   2. Operator-configured MEM0_USER_ID (env or $HERMES_HOME/mem0.json).
        #   3. Gateway-native id from kwargs (Telegram numeric id, Discord snowflake, etc.).
        ...
        if configured == _DEFAULT_USER_ID:
            configured = None
        self._user_id = kwargs.get("memory_scope") or configured or kwargs.get("user_id") or _DEFAULT_USER_ID
